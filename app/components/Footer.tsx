    ...
    return (
        <footer className="rounded-lg shadow m-4">
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 sm:text-center ">© 2024 <a href="https://flowbite.com/" className="hover:underline">Cloud Kinetics</a>. All Rights Reserved.
                </span>
                <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 sm:mt-0">
                    ...
                    <li>
                        <a href="https://www.cloud-kinetics.com/services/applications-software-engineering/devops/" className="hover:underline me-4 md:me-6">DevSecOps</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="https://www.cloud-kinetics.com/information-security-policy/" className="hover:underline">Information Security Policy</a>
                    </li>
                </ul>
            </div>
        </footer>
